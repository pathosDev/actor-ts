      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Utility helpers', slug: 'reference/utility-helpers', translations: { de: 'Hilfsfunktionen', es: 'Utilidades', fr: 'Utilitaires', ja: 'ユーティリティ', ko: '유틸리티', 'pt-BR': 'Utilitários', ru: 'Утилиты', 'zh-CN': '实用工具' } },
