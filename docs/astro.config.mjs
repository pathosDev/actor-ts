          ...
          items: [
            {
              ...
              items: [
                ...
                { label: 'Parallelism',           slug: 'fundamentals/parallelism',           translations: { de: 'Parallelität', es: 'Paralelismo', fr: 'Parallélisme', ja: '並列性', ko: '병렬성', 'pt-BR': 'Paralelismo', ru: 'Параллелизм', 'zh-CN': '并行' } },
                { label: 'Blocking and CPU-bound work', slug: 'fundamentals/blocking-and-cpu-bound-work', translations: { de: 'Blockierende und CPU-lastige Arbeit', es: 'Trabajo bloqueante y de CPU', fr: 'Travail bloquant et CPU', ja: 'ブロッキングと CPU 負荷の高い処理', ko: '블로킹 및 CPU 집약 작업', 'pt-BR': 'Trabalho bloqueante e de CPU', ru: 'Блокирующая и CPU-нагрузка', 'zh-CN': '阻塞与 CPU 密集型工作' } },
                ...
                { label: 'Throttling',            slug: 'fundamentals/throttling',            translations: { de: 'Throttling', es: 'Regulación', fr: 'Throttling', ja: 'スロットリング', ko: '스로틀링', 'pt-BR': 'Throttling', ru: 'Тротлинг', 'zh-CN': '限流' } },
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { label: 'Error handling', slug: 'http/error-handling', translations: { de: 'Fehlerbehandlung', es: 'Manejo de errores', fr: 'Gestion des erreurs', ja: 'エラー処理', ko: '오류 처리', 'pt-BR': 'Tratamento de erros', ru: 'Обработка ошибок', 'zh-CN': '错误处理' } },
                { label: 'HTML & XSS', slug: 'http/html-xss', translations: { de: 'HTML & XSS', es: 'HTML y XSS', fr: 'HTML et XSS', ja: 'HTML と XSS', ko: 'HTML 및 XSS', 'pt-BR': 'HTML e XSS', ru: 'HTML и XSS', 'zh-CN': 'HTML 与 XSS' } },
                { label: 'Static files', slug: 'http/static-files', translations: { de: 'Statische Dateien', es: 'Archivos estáticos', fr: 'Fichiers statiques', ja: '静的ファイル', ko: '정적 파일', 'pt-BR': 'Arquivos estáticos', ru: 'Статические файлы', 'zh-CN': '静态文件' } },
                {
                  label: 'Backends',
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { label: 'CORS',            slug: 'http/middleware/cors',            translations: { de: 'CORS', es: 'CORS', fr: 'CORS', ja: 'CORS', ko: 'CORS', 'pt-BR': 'CORS', ru: 'CORS', 'zh-CN': 'CORS' } },
                    { label: 'CSRF',            slug: 'http/middleware/csrf',            translations: { de: 'CSRF', es: 'CSRF', fr: 'CSRF', ja: 'CSRF', ko: 'CSRF', 'pt-BR': 'CSRF', ru: 'CSRF', 'zh-CN': 'CSRF' } },
                ...
                { label: 'Security', slug: 'http/security', translations: { de: 'Sicherheit', es: 'Seguridad', fr: 'Sécurité', ja: 'セキュリティ', ko: '보안', 'pt-BR': 'Segurança', ru: 'Безопасность', 'zh-CN': '安全' } },
              ],
            },
            {
              label: 'Cache',
