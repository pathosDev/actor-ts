          ...
          items: [
            { label: 'Overview', slug: 'observability/overview', translations: { de: 'Überblick', es: 'Visión general', fr: 'Vue d’ensemble', ja: '概要', ko: '개요', 'pt-BR': 'Visão geral', ru: 'Обзор', 'zh-CN': '概览' } },
            {
              ...
              items: [
                ...
                { label: 'OTel adapter',        slug: 'observability/metrics/otel-adapter',        translations: { de: 'OTel-Adapter', es: 'Adaptador OTel', fr: 'Adaptateur OTel', ja: 'OTel アダプタ', ko: 'OTel 어댑터', 'pt-BR': 'Adaptador OTel', ru: 'Адаптер OTel', 'zh-CN': 'OTel 适配器' } },
