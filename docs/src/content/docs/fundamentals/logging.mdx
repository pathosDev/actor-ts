...
| [`Props.withDisplayName(name)`](/fundamentals/props/) | The spawn site knows the name and the actor doesn't — a sharded entity, a singleton, anything the framework constructs. |
