...
See [Supervision](/actor-ts/fundamentals/supervision/) for the
...
See [Mailboxes](/actor-ts/fundamentals/mailboxes/) for the
...
`Behaviors.setup(...)` flow); see [Typed actors](/actor-ts/typed/typed-actor/).
...
- **[Mailboxes](/actor-ts/fundamentals/mailboxes/)** — the queue
...
The [`Props`](/actor-ts/api/classes/props/) API reference covers
