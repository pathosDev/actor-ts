...
See [JsonSerializer](/actor-ts/serialization/json/) +
[CborSerializer](/actor-ts/serialization/cbor/) for details.
...
See [Custom serializers](/actor-ts/serialization/custom/) for
the full setup.
...
<Aside type="caution" title="Test what crosses the boundary">
  ...
  [MultiNodeSpec](/actor-ts/testing/multi-node-spec/) or
...
- **[Custom serializers](/actor-ts/serialization/custom/)** —
  Protobuf, Avro, etc.
- **[Messages](/actor-ts/fundamentals/messages/)** — what
