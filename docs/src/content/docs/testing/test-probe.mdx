...
[pipeTo](/actor-ts/patterns/futures-patterns/), or any class-based
message type.
...
- **[TestKit](/actor-ts/testing/testkit/)** — the wrapper that
  creates the probe.
- **[Testing overview](/actor-ts/testing/overview/)** — when to
...
The [`TestProbe`](/actor-ts/api/classes/testprobe/) API reference
