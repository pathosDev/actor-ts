...
journal page in [Persistence](/actor-ts/persistence/overview/) for
the per-plugin keys.
...
| Subtree | Page |
| --- | --- |
| `io.broker.kafka` | [Kafka](/actor-ts/io/kafka/) |
| `io.broker.mqtt` | [MQTT](/actor-ts/io/mqtt/) |
| `io.broker.amqp` | [AMQP](/actor-ts/io/amqp/) |
| `io.broker.nats` | [NATS](/actor-ts/io/nats/) |
| `io.broker.jetstream` | [JetStream](/actor-ts/io/nats/) *(same page, JetStream variant)* |
| `io.broker.redis-streams` | [Redis Streams](/actor-ts/io/redis-streams/) |
| `io.broker.grpc.{client,server}` | [gRPC](/actor-ts/io/grpc/) |
| `io.broker.websocket` | [WebSocket client](/actor-ts/io/websocket/) |
| `io.broker.sse` | [SSE](/actor-ts/io/sse/) |
| `io.broker.tcp` | [TCP](/actor-ts/io/tcp/) |
| `io.broker.udp` | [UDP](/actor-ts/io/udp/) |
...
- **[Cluster overview](/actor-ts/cluster/overview/)** — the keys
