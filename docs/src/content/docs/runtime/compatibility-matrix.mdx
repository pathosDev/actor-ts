...
description: Feature-by-feature support across Bun, Node 20+, and Deno. Use this page to verify before adopting a subsystem.
---
...
For Node-shop environments:                    Node 20+
For Lambda / serverless:                       Node 20+
