...
[SSE](/io/sse/) is simpler.  For request/reply RPC,
[HTTP](/http/overview/) (with WS for upgrade) is the
norm.
...
- **[SSE](/io/sse/)** — server-sent events
  alternative.
- **[HTTP overview](/http/overview/)** — for regular
