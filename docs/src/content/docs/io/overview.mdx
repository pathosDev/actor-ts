---
title: I/O overview
description: How actors talk to the outside world — broker actors (Kafka, MQTT, AMQP, NATS, Redis Streams, gRPC, WebSocket, SSE, TCP, UDP) all extend `BrokerActor`, sharing one lifecycle + reconnect + buffer pattern.
---
