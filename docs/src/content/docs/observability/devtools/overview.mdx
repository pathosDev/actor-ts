...
couple of seconds without an answer the UI says **No node reachable**
across the top, dims the panel to mark the figures as frozen rather than
live, and keeps retrying.  It clears itself when something answers again.
