...
For single-pod, [in-memory](/actor-ts/cache/in-memory/) is
simpler.
...
- **[Cache overview](/actor-ts/cache/overview/)** — the
  bigger picture.
- **[In-memory cache](/actor-ts/cache/in-memory/)** — for
  single-pod.
- **[Memcached cache](/actor-ts/cache/memcached/)** —
  alternative.
- **[HTTP middleware](/actor-ts/http/middleware/response-cache/)** —
