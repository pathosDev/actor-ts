...
[downing strategy](/actor-ts/cluster/downing-strategies/) +
...
see [Coordination](/actor-ts/coordination/overview/) for the
interface.
...
[downing strategy](/actor-ts/cluster/downing-strategies/), the
