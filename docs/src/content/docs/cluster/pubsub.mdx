...
| Bus | Scope | Topic key |
| --- | --- | --- |
| [Event stream](/actor-ts/fundamentals/event-stream/) | One ActorSystem | Class (`instanceof`) |
...
- **[Event stream](/actor-ts/fundamentals/event-stream/)** — the
...
The [`DistributedPubSubMediator`](/actor-ts/api/classes/distributedpubsubmediator/)
