...
The default
[`PersistenceQuery`](/actor-ts/persistence/persistence-query/) is
...
- The framework's
  [DistributedPubSub](/actor-ts/cluster/pubsub/) handles
...
- **[Persistence query](/actor-ts/persistence/persistence-query/)** —
  the underlying API.
- **[Projections](/actor-ts/persistence/projections/)** — what
  consumes the bus.
