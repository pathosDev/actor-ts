...
```
  ...
  ▼     closed       │    │       open       ▼
  ░░░░░░░░░░░░░░░░░░ │    │   ░░░░░░░░░░░░░░░░
  calls pass through │    │   calls fail fast
                     │    │
        failures ≥ maxFailures      reset timeout elapsed
                     │    │
                     ▼    │
                  half-open
                 first call after
...
- **[Retry](/actor-ts/patterns/retry/)** — the complementary
...
- **[Ask pattern](/actor-ts/fundamentals/ask-pattern/)** — what
  you'd typically wrap when the call is actor-to-actor.

The [`CircuitBreaker`](/actor-ts/api/classes/circuitbreaker/) API
