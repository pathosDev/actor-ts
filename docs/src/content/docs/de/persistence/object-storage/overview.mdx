...
Zwei Grenzen sollte man kennen, denn sonst nimmt man mehr an, als
...
erreichbar.  Und sie schließt die *eigenen* Operationen des
Backends ein; sie ist keine Sandbox um ein Verzeichnis, in das
andere lokale Prozesse schreiben dürfen.  Wenn nicht
vertrauenswürdige Nutzer Einträge im Storage-Root anlegen können,
ist das bereits das größere Problem.
