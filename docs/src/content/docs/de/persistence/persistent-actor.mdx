...
| [`BidirectionalMap`](/de/reference/utility-helpers/#bidirectionalmap--eine-map-mit-gepflegter-umkehrung) | **Round-trippt als echte Instanz** — die einzige Framework-Klasse mit eigenem Tag (#1035).  Gespeichert wird nur die Vorwärtsrichtung; die Umkehrung wird beim Dekodieren rekonstruiert. |
