...
| `PostgresSnapshotStore` | PostgreSQL-gestützte Produktion. |
| `MariaDbSnapshotStore` | MariaDB / MySQL-gestützte Produktion. |
| `LibSqlSnapshotStore` | libSQL / Turso — entferntes SQLite über HTTP. |
| `MsSqlSnapshotStore` | Microsoft SQL Server-gestützte Produktion. |
| `MongoSnapshotStore` | MongoDB-gestützte Produktion. |
| `DynamoDbSnapshotStore` | DynamoDB-gestützte Produktion. |
| `D1SnapshotStore` | Cloudflare D1 — SQLite am Edge. |
| `CassandraSnapshotStore` | Verteilt — Cassandra / ScyllaDB. |
