...
```ts
// Push-Zustellung braucht ein Journal mit In-Process-Event-Bus —
// SqliteJournal (und InMemoryJournal) haben einen; SqliteQuery umschließt diese Instanz.
