...
In-Memory, SQLite, Postgres, Mongo und DynamoDB wird ein Override
hier stillschweigend fallen gelassen — keine Verschlüsselung,
keine Manipulationserkennung und kein Fehler, der dich darauf
hinweist.  Prüfe den Override gegen den Store, den du tatsächlich
betreibst, bevor du ihn als greifende Kontrolle behandelst.
