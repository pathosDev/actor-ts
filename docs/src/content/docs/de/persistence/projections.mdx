...
// (Postgres, MariaDB, libSQL, Object-Storage), sodass ein Neustart mittendrin fortsetzt:
...
- `DurableStateOffsetStore` — umschließt einen beliebigen `DurableStateStore`
  (Postgres, MariaDB, libSQL, Object-Storage), sodass Offsets Neustarts überstehen.
