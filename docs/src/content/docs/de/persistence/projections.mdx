...
// (Postgres, MariaDB, libSQL, SQL Server, MongoDB, Object-Storage), sodass ein Neustart mittendrin fortsetzt:
...
- `DurableStateOffsetStore` — umschließt einen beliebigen `DurableStateStore`
  (Postgres, MariaDB, libSQL, SQL Server, MongoDB, Object-Storage), sodass Offsets Neustarts überstehen.
