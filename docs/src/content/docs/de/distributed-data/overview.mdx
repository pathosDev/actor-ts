...
Die Deep Dives zu den CRDT-Typen behandeln `merge()`-Semantik, wann
sie passen und wann nicht —
[Counter](/de/distributed-data/crdt-types/counters/),
[Register](/de/distributed-data/crdt-types/registers/),
[Sets](/de/distributed-data/crdt-types/sets/) und
...
| `{ from: 3 }` | Auf genau `from` ACKs warten (begrenzt auf `[1, N]`). |
...
- **[Counter](/de/distributed-data/crdt-types/counters/)** — der erste
  der CRDT-Typ-Deep-Dives; jede Seite verlinkt weiter auf Register,
  Sets und Maps.
