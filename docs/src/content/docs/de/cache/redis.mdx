...
const redisCacheOptions = RedisCacheOptions.create()
  .withUrl('redis://redis.example.com:6379');
...
```ts
interface RedisCacheOptionsType {
...
const redisCache2Options = RedisCacheOptions.create()
  .withUrl('rediss://redis.example.com:6380');
new RedisCache(redisCache2Options);  // TLS
const redisCache3Options = RedisCacheOptions.create()
  .withUrl('redis://user:pass@host:6379');
