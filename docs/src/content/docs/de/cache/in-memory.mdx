...
Aktualität ist allerdings nicht das *einzige* Kriterium: welche Einträge
die Schranke zuerst greift, hängt davon ab, was sie tragen — darum geht
...
- **Die Politik ordnet Garantien nicht gegeneinander.**  Zwei Consumer,
  die je eine Garantie tragen und sich eine Instanz teilen, evictieren
  sich weiterhin gegenseitig; ein Cache pro Consumer bleibt daher die
  Empfehlung (unten).
...
durch.  Der Name gehört dir, deshalb sind diese Pfade nicht in
...
Das verkleinert den Explosionsradius, beseitigt ihn aber nicht: eine
Middleware, deren eigener Key-Raum angreiferkontrolliert ist, kann
weiterhin ihre eigenen Einträge evictieren — ein Client mit einem
IPv6-`/64` erzeugt beliebig viele Rate-Limit-Keys, und jeder davon ist
ein Zähler, den diese Politik schützt.  Wo das zählt, hinterlege den
