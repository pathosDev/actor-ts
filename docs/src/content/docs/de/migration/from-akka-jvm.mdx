...
| `EventStream` | `system.eventStream` (node-lokal, wie auf der JVM) |
| — | `cluster.eventStream` (dieselben Channels, clusterweit) |
...
Dasselbe Modell, weniger Zeremonie — der Actor deklariert seine
