...
Zweitens lebt die Marke nur so lange wie ihr Absender. Ein
gelöschtes Member verliert seine Marke, und eine fehlende Marke
lässt alles zu. Sobald also der **Absender** selbst evakuiert
wurde (eine gewöhnliche Partition trifft Absender und Subjekt
gemeinsam), lässt sich die mitgeschnittene Konversation in
Aufnahmereihenfolge abspielen: Der Selbstdatensatz des Absenders
wird immer zugelassen, wodurch er wiederbelebt *und* die Marke aus
dem alten Frame neu gesetzt wird — und der nächste mitgeschnittene
Frame spricht dann für das Subjekt. Eine Inkarnationsidentität
schließt auch das nicht: Ein Knoten, der heruntergefahren wurde,
während er noch läuft, antwortet unter derselben Inkarnation, die
der Mitschnitt trägt.
