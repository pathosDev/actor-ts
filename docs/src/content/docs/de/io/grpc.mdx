...
const getHandler = system.spawn(() => new GetSensorHandler(), 'get');
const watchHandler = system.spawn(() => new WatchSensorHandler(), 'watch');
...
const collector = system.spawn(() => new ReplyCollector(), 'collector');
