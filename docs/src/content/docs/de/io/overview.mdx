...
description: Wie Actors mit der Außenwelt sprechen — Broker-Actors (Kafka, MQTT, AMQP, NATS, Redis Streams, gRPC, WebSocket, SSE, TCP, UDP) erben alle von `BrokerActor` und teilen sich ein gemeinsames Muster für Lifecycle + Reconnect + Buffer.
---
