...
| Einen Routee | Supervisor restartet ihn (Default); wird er gestoppt, bleibt seine tote Ref im Pool und Round-Robin routet ihm weiter ~jede N-te Nachricht → Dead Letters. | Router stoppt das Senden an ihn (nachdem der Cluster es bemerkt), Geschwister unberührt. |
