...
reagiert.  `producerId` und `seq` sind beide erratbar, das Inkarnations-Token
ist es nicht, und es verlässt den Producer nur auf Deliveries, die er
tatsächlich gesendet hat.  Ohne diese Prüfung könnte alles, das den Producer
