...
Entity. Eine Folge ist erwähnenswert: nach der Ref eines passivierten
Shards mit [`shardRefFor()`](/de/cluster/sharding/introspection/) zu
fragen, holt ihn zurück — ein Handle auf einen nicht laufenden Actor
wäre ein Handle auf nichts.
