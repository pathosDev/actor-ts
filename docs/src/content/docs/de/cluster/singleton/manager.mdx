...
system.actorOf(
  ClusterSingletonManager.props({
    ...
    lease:           leaseImpl,                  // optionaler Split-Brain-Schutz
    acquireRetryIntervalMs: 5_000,                // wenn Lease-Acquire scheitert
  }),
...
<Aside type="caution" title="Manager-Name muss der Konvention folgen">
  ```ts
  system.actorOf(ClusterSingletonManager.props({...}), 'whatever');
