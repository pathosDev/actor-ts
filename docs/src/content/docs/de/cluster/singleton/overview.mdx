...
import { ClusterSingletonManager, ClusterSingletonManagerOptions, ClusterSingletonProxy } from 'actor-ts';

class JobScheduler extends Actor<JobCommand> {
  override onReceive(msg: JobCommand): void { /* ... */ }
}
...
const clusterSingletonManagerOptions = ClusterSingletonManagerOptions.create<JobCommand>()
  .withCluster(cluster)
...
system.spawn(
  ClusterSingletonManager.props(
    clusterSingletonManagerOptions,   // optional: nur diese Nodes können hosten
  ),
