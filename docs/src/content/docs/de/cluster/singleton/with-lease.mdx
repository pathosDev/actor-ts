...
- **Pufferung beim Sender** — der Singleton-Proxy puffert, solange
  ...
  da ist.  Der Puffer ist gedeckelt (`withBufferSize`, Default
  1000); jenseits des Limits gehen Nachrichten mit einer Warnung in
  die Dead Letters, damit eine Lücke, die sich nie schließt, nicht
