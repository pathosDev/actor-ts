...
- eine durch `context.throttle(...)` geparkte Mailbox und eine, die
  suspendiert ist, während ein Supervisor entscheidet — keine von
  beiden leert sich in einem Tempo, auf das ein Shutdown warten kann,
  also gelten beide als ruhig;
