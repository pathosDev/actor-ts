...
<Aside type="caution" title="Eine begrenzte Priority-Mailbox kann beim Unstash droppen">
  ...
  `BoundedMailbox` verhält sich hier anders: ihr Unstash-Pfad umgeht den
  Bound.
</Aside>
...
Stash-Reihenfolge wird innerhalb einer Priority-Schicht bewahrt.  Dieses
Re-Insert läuft durch `enqueue`, auf einer *begrenzten* Priority-Mailbox
gilt die Capacity also auch für das Wiedereinspielen — siehe die Warnung
oben.
