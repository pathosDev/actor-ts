...
<Aside type="caution" title="Stash + Restart = Zustand verloren">
  ...
  Stash-Buffers.  Gestashed Nachrichten werden stillschweigend
  verworfen, nicht zu Dead Letters geroutet.  Wenn die Nachrichten
  über den Fehler hinweg wichtig sind, persistiere sie
  (PersistentActor) oder lass einen Parent sie nach Abschluss des
  Restarts erneut senden.
</Aside>
