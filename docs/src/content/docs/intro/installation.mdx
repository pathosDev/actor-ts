...
| `mongodb` *(pin `^6`)* | MongoDB journal + snapshot + durable-state store + indexed tag query.  Version 7 cannot be imported on Bun — see the [MongoDB page](/persistence/journals/mongodb/). |
