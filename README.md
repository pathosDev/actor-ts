...
<p align="center">
  ...
  <a href="#"><img alt="tests" src="https://img.shields.io/badge/tests-1104%20of%201105-ef4444?style=flat-square&logo=bun"/></a>
...
> production**.  Test coverage is good (~1104 tests, ~81 % line) but the
...
- Nothing.  This is an experimental hobby project (~1104 tests, ~81 % line coverage).
...
itself** (~1104 tests under `tests/`) uses `bun:test` and therefore runs
...
tests/unit/     — most of the ~1104 tests live here
