...
<p align="center">
  ...
  <a href="#"><img alt="tests" src="https://img.shields.io/badge/tests-1529%20of%201530-ef4444?style=flat-square&logo=bun"/></a>
...
> production**.  Test coverage is good (~1529 tests, ~83 % line) but the
...
- Nothing.  This is an experimental hobby project (~1529 tests, ~83 % line coverage).
...
itself** (~1529 tests under `tests/`) uses `bun:test` and therefore runs
...
tests/unit/     — most of the ~1529 tests live here
