...
<p align="center">
  ...
  <a href="#"><img alt="tests" src="https://img.shields.io/badge/tests-1593%20of%201593-22c55e?style=flat-square&logo=bun"/></a>
  <a href="#"><img alt="coverage" src="https://img.shields.io/badge/coverage-~84%25-22c55e?style=flat-square"/></a>
</p>
...
> production**.  Test coverage is good (~1593 tests, ~84 % line) but the
...
- Nothing.  This is an experimental hobby project (~1593 tests, ~84 % line coverage).
...
itself** (~1593 tests under `tests/`) uses `bun:test` and therefore runs
...
tests/unit/     — most of the ~1593 tests live here
