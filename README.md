...
<p align="center">
  ...
  <a href="#"><img alt="tests" src="https://img.shields.io/badge/tests-1490%20of%201490-22c55e?style=flat-square&logo=bun"/></a>
...
> production**.  Test coverage is good (~1490 tests, ~83 % line) but the
...
- Nothing.  This is an experimental hobby project (~1490 tests, ~83 % line coverage).
...
itself** (~1490 tests under `tests/`) uses `bun:test` and therefore runs
...
tests/unit/     — most of the ~1490 tests live here
