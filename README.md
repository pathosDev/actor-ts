...
<p align="center">
  ...
  <a href="#"><img alt="tests" src="https://img.shields.io/badge/tests-1626%20of%201627-ef4444?style=flat-square&logo=bun"/></a>
...
> production**.  Test coverage is good (~1626 tests, ~84 % line) but the
...
- Nothing.  This is an experimental hobby project (~1626 tests, ~84 % line coverage).
...
itself** (~1626 tests under `tests/`) uses `bun:test` and therefore runs
...
tests/unit/     — most of the ~1626 tests live here
