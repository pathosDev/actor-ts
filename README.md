...
<p align="center">
  ...
  <a href="#"><img alt="tests" src="https://img.shields.io/badge/tests-1161%20of%201162-ef4444?style=flat-square&logo=bun"/></a>
...
> production**.  Test coverage is good (~1161 tests, ~82 % line) but the
...
- Nothing.  This is an experimental hobby project (~1161 tests, ~82 % line coverage).
...
itself** (~1161 tests under `tests/`) uses `bun:test` and therefore runs
...
tests/unit/     — most of the ~1161 tests live here
