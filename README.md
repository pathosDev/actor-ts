...
<p align="center">
  ...
  <a href="#"><img alt="tests" src="https://img.shields.io/badge/tests-1420%20of%201421-ef4444?style=flat-square&logo=bun"/></a>
...
> production**.  Test coverage is good (~1420 tests, ~83 % line) but the
...
- Nothing.  This is an experimental hobby project (~1420 tests, ~83 % line coverage).
...
itself** (~1420 tests under `tests/`) uses `bun:test` and therefore runs
...
tests/unit/     — most of the ~1420 tests live here
