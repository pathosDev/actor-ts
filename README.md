...
<p align="center">
  ...
  <a href="#"><img alt="tests" src="https://img.shields.io/badge/tests-1078%20of%201079-22c55e?style=flat-square&logo=bun"/></a>
...
> production**.  Test coverage is good (~1078 tests, ~81 % line) but the
...
- Nothing.  This is an experimental hobby project (~1078 tests, ~81 % line coverage).
...
itself** (~1078 tests under `tests/`) uses `bun:test` and therefore runs
...
tests/unit/     — most of the ~1078 tests live here
