...
/**
 * The four scenarios expressed in the Pekko Typed Java API.
 *
 ...
 *
 * <p>The one structural difference worth naming: in Pekko Typed only an actor may
...
public final class Actors {
    ...
    private static final class Guardian extends AbstractBehavior<GuardianCommand> {
        ...
        private Behavior<GuardianCommand> onSpawnBatch(SpawnBatch message) {
            ...
            // immediately reusable in Pekko, so reusing plain indices would fail
         ...
         * when the actor actually starts — the Pekko analogue of the {@code preStart}
