...
import { resolveWsPolicy, type ResolvedWsPolicy, type WebSocketPolicyOptions } from './WsPolicy.js';

export interface WebSocketRouteOptions<TOut, TIn> extends WebSocketPolicyOptions {
...
export function websocket<TOut, TIn, TSelf = never>(
  ...
  let options: WebSocketRouteOptions<TOut, TIn>;
  if (typeof a === 'string') {
    segment = a;
    ...
    segment = null;
    target = a;
    options = (b as WebSocketRouteOptions<TOut, TIn> | undefined) ?? {};
  }
